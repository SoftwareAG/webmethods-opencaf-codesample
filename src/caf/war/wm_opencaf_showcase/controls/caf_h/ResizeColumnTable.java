...
@ManagedBean(name="resizeColumnTableBean")
@SessionScoped
@ExpireWithPageFlow
public class ResizeColumnTable extends BaseFacesBean {
	...
	public String storeColumnWidths() {
		//TODO: store the columnWidths somewhere to use later.
		return null;
	}
